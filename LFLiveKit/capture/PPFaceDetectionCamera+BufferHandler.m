//
//  PPFaceDetectionCamera+BufferHandler.m
//  Pods
//
...
@implementation PPFaceDetectionCamera (BufferHander)
...
- (void)grepFacesForSampleBuffer:(CMSampleBufferRef)sampleBuffer
{
    ...
    if ([self.detectionDelegate respondsToSelector:@selector(detectorWillOutputFaceFeatures:inClap:)]) {
        [self.detectionDelegate detectorWillOutputFaceFeatures:self.coreImageFaceFeatures inClap:self.clap];
    }
